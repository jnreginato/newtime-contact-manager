...
/**
 * Factory class for creating instances of UpdateContactHandler.
 *
 * This class is responsible for creating a RequestHandlerDecorator instance
 * wrapping UpdateContactHandler with the necessary dependencies.
 */
final readonly class UpdateContactHandlerFactory
{
    /**
     * Create an instance of RequestHandlerDecorator wrapping UpdateContactHandler.
     *
    ...
    {
        $useCase = $container->get(UpdateContactUseCase::class);
        assert($useCase instanceof UpdateContactUseCase);

        $handler = new UpdateContactHandler($useCase);

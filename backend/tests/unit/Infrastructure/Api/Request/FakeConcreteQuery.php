...
final readonly class FakeConcreteQuery extends PaginatedQuery
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            (int) ($data['filterJoinType'] ?? 0), // @phpstan-ignore-line
            (array) ($data['filter'] ?? []), // @phpstan-ignore-line
            (array) ($data['sort'] ?? []), // @phpstan-ignore-line
            (array) ($data['include'] ?? []), // @phpstan-ignore-line
            (array) ($data['fields'] ?? []), // @phpstan-ignore-line
        );
    }
}
